...
class KotlinCompilation {
	...
	private fun stubsAndApt(sourceFiles: List<File>): com.tschuchort.compiletesting.ExitCode {
		if(annotationProcessors.isEmpty()) {
			log("No services were given. Not running kapt steps.")
			return com.tschuchort.compiletesting.ExitCode.OK
		}
	...
	private fun compileKotlin(sourceFiles: List<File>): com.tschuchort.compiletesting.ExitCode {
	...
	private fun compileJava(sourceFiles: List<File>): com.tschuchort.compiletesting.ExitCode {
        ...
        if(jdkHome != null) {
            ...
            return when(javacProc.waitFor()) {
                0 -> com.tschuchort.compiletesting.ExitCode.OK
                1 -> com.tschuchort.compiletesting.ExitCode.COMPILATION_ERROR
                else -> com.tschuchort.compiletesting.ExitCode.INTERNAL_ERROR
            }
        }
        else {
            ...
            try {
                ...
                return if(noErrors)
                    com.tschuchort.compiletesting.ExitCode.OK
                else
                    com.tschuchort.compiletesting.ExitCode.COMPILATION_ERROR
            }
            catch (e: Exception) {
                if(e is RuntimeException || e is IllegalArgumentException) {
                    printDiagnostics()
                    error(e.toString())
                    return com.tschuchort.compiletesting.ExitCode.INTERNAL_ERROR
                }
                else
                    throw e
            }
		...
		*/
		withSystemProperty("idea.use.native.fs.for.win", "false") {
			...
			try {
				...
				if (exitCode != com.tschuchort.compiletesting.ExitCode.OK) {
				...
				CommonComponentRegistrar.threadLocalParameters.remove()
			}
